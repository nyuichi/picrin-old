...
static void destroy_synclo(pic_obj_t obj)
{
...
{
    pic_synclo_t * obj = pic_malloc(sizeof(pic_synclo_t),
                                 PIC_TYPE_SYNCLO,
                                 destroy_synclo);
    PIC_XINCREF(freeenv);
...
static void destroy_macro(pic_obj_t obj)
{
...
{
    pic_macro_t * obj = pic_malloc(sizeof(pic_macro_t),
                                PIC_TYPE_MACRO,
                                destroy_macro);
